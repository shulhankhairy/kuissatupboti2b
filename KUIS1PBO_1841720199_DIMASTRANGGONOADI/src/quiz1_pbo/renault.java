...
public class renault extends mesin {
 Scanner sc = new Scanner(System.in);   
    ...
    public renault(int kecepatan, String merk) {
        ...
        if(kecepatanTambahan >65){
            System.out.println("Kecepatan hanya dapat ditambahkan sebesar 65 KM/JAM");
        }
        else{
        ...
        kecepatanTambahan = sc.nextInt();
        if(kecepatanTambahan >35){
            System.out.println("Kecepatan hanya dapat dikurangi sebesar 35 KM/JAM");
        }else{
